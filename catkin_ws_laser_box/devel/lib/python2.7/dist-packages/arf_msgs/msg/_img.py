"""autogenerated by genpy from arf_msgs/img.msg. Do not edit."""
import sys
...
class img(genpy.Message):
  _md5sum = "87b0f74e5329be27eec8c1675e43d90b"
  _type = "arf_msgs/img"
...
"""
  __slots__ = ['header','seq','img']
  _slot_types = ['std_msgs/Header','int32','sensor_msgs/Image']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_i3I.pack(_x.seq, _x.img.header.seq, _x.img.header.stamp.secs, _x.img.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.seq, _x.img.header.seq, _x.img.header.stamp.secs, _x.img.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
