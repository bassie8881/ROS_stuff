...
message(STATUS "ble_scanner: 2 messages, 0 services")

set(MSG_I_FLAGS "-Ible_scanner:/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg/BLEBeacon.msg" NAME_WE)
add_custom_target(_ble_scanner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ble_scanner" "/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg/BLEBeacon.msg" ""
)

get_filename_component(_filename "/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg/BLEData.msg" NAME_WE)
add_custom_target(_ble_scanner_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ble_scanner" "/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg/BLEData.msg" "std_msgs/Header:ble_scanner/BLEBeacon"
)
...
_generate_msg_cpp(ble_scanner
  "/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg/BLEBeacon.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ble_scanner
)
_generate_msg_cpp(ble_scanner
  "/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg/BLEData.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/indigo/share/std_msgs/cmake/../msg/Header.msg;/home/odroid/git_laser_scanner/src/laser_scanner/ble_scanner/msg/BLEBeacon.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ble_scanner
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ble_scanner)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ble_scanner\")")
  # install generated code
  install(
